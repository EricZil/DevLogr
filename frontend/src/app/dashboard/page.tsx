...
// Define types for projects and updates
interface Project {
  id: string;
  title: string;
...
export default function Dashboard() {
  ...
  // Compute 7-day updates trend for sparkline (counts per day)
  ...
  // Fetch initial data when user is available (placed after helper functions to avoid TS hoist issues)
  useEffect(() => {
    if (user) {
      fetchProjects();
      fetchRecentUpdates();
  ...
  // Calculate stats after projects are loaded
  useEffect(() => {
    if (projects.length >= 0) {
      fetchStats();
    }
  ...
  // Badge style for update type labels
  ...
  // Helper: group updates by date label (Today, Yesterday, or formatted date)
  ...
  return (
    <div className="min-h-screen bg-black relative overflow-hidden">
      ...
      <main className="relative z-10 max-w-7xl mx-auto px-6 py-12">
        ...
        {/* Stats Cards using reusable KpiCard component */}
